...
npm test               # engine/bank smoke (1956) + DOM (99) + admin (35) + store (36) + demo (1214)
...
test/            smoke (1956) · dom (99) · admin (35) · store (36) · demo (1214) · api (~140, CAT-length dependent) — 3,480+ checks total
```
