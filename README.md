...
npm test               # engine/bank smoke (1572) + DOM (99) + admin (35) + store (36) + demo (1214)
...
test/            smoke (1572) · dom (99) · admin (35) · store (36) · demo (1214) · api (~140, CAT-length dependent) — 3,090+ checks total
```
